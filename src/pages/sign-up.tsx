...
export default function LoginForm() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-black">
        <form
          ...
          className="bg-white shadow-lg rounded-xl p-8 flex flex-col gap-4 w-full max-w-sm"
        >
          ...
          <button
            ...
            className="bg-green-100 hover:bg-green-300 text-green-900 font-semibold py-2 rounded-lg transition"
          >
            Załóż konto
          </button>
          <div className="flex items-center my-2">
            <div className="flex-1 border-t border-gray-300" />
            <span className="mx-2 text-gray-400 text-xs">lub</span>
            <div className="flex-1 border-t border-gray-300" />
          </div>
          <button
            type="button"
            onClick={() => signIn("google")}
            className="flex items-center justify-center gap-2 px-4 py-2 bg-red-100 hover:bg-red-300 text-red-700 font-semibold rounded-lg transition"
          >
            <svg
  ...
  if (showRegiter) return <RegisterForm setShowRegister={setShowRegister} />;
}
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-black ">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-green-500 hover:bg-green-700 text-white font-semibold py-2 rounded-lg transition"
        >
          Zarejestruj się
        </button>
        <button
          ...
          className="bg-blue-100 hover:bg-blue-300 text-blue-900 font-semibold py-2 rounded-lg transition"
        >
          Mam już konto
        </button>
      </form>
